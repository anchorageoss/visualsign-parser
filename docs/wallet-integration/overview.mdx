...
flowchart TD
    ...
    Q3 -->|Separate service| SIDECAR[Sidecar Deployment]
```

## Comparison

| | Turnkey Hosted | Self-Hosted TEE | Library | Sidecar |
|---|---|---|---|---|
...
Embed the VisualSign parser directly in your application. Available as a Rust crate that can be compiled to native code or WebAssembly.

**Options:**
- **Rust native** — Link directly into Rust applications
- **WASM** — Run in browsers or any WASM runtime
- **FFI** — Call from C, Go, Python, or other languages that support C FFI
...
[Get started with Sidecar Deployment →](./sidecar/getting-started)
...
**Library or Sidecar deployments are appropriate when:**
...
- [Sidecar Deployment](./sidecar/getting-started) — Simple gRPC service
