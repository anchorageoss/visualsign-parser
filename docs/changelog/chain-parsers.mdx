---
title: "Changelog — Chain parsers"
description: "New chain support, preset additions, IDL handling, and decoder fixes. One entry per meaningful release."
---

Subscribe via RSS at [`/changelog/chain-parsers/rss.xml`](/changelog/chain-parsers/rss.xml). Filter by tag — `Solana`, `Ethereum`, `Wallet API`, `Contributors`.

<Update label="2026-05-12 — Solana preset wave" description="v0.646.0 — v0.649.0" tags={["Wallet API", "Contributors", "Solana"]}>
...
<Update label="2026-05-12 — Surfpool mainnet-fork integration for IDL fuzz testing" description="v0.647.0" tags={["Contributors", "Solana"]}>
