...
description: Threat model, trust architecture, and security guarantees
---

VisualSign solves a fundamental problem in blockchain security: users cannot verify what they are signing. This page explains the threat model, trust architecture, and security guarantees that VisualSign provides.
...
- [Attestation Verification Guide](./verification)
