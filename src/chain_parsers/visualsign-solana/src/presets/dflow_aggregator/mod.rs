...
> {
    ...
    expanded_fields.push(create_text_field("Program", "DFlow Aggregator")?);
...
mod tests {
    ...
    fn test_build_named_accounts_surfaces_extra_accounts() {
        ...
        // close_empty_token_account has 4 named accounts; provide 6 to get 2 extras
        let accounts = dummy_account_strings(6);
        ...
        assert_eq!(extra[0], accounts[4]);
        assert_eq!(extra[1], accounts[5]);
    }
