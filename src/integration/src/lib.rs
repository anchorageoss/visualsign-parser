...
fn setup_manifest(test_id: &str) -> PathWrapper<String> {
    let path: PathWrapper<String> = format!("./{test_id}.manifest_envelope").into();
...
/// Test the k8s health check endpoint.
...
/// Test the k8s health "watch" endpoint.
